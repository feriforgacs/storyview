...
<div class="ff_storyview_block_item ff_storyview_block_item_code" id="ff_storyview_block_item_<?php echo $storyview_block_id; ?>" data-blockid="<?php echo $storyview_block_id; ?>">
    ...
    <div class="ff_storyview_block_item_preview ff_storyview_block_item_preview_code">
        ...
        <div class="ff_storyview_block_item_content" style="<?php
        // display custom background color
        echo "background-color: " . $storyview_block_item_block_background_color . ";";
            ...
            <div class="ff_storyview_row">
                <div class="ff_storyview_col_md_6">
                    ...
                    <div class="ff_storyview_background_color_colorpicker">
                        <input data-blockid="<?php echo $storyview_block_id; ?>" type="text" name="ff_storyview_block_item_block_background_color_<?php echo $storyview_block_id; ?>" id="ff_storyview_block_item_block_background_color_<?php echo $storyview_block_id; ?>" class="ff_storyview_custom_background_color_colorpicker_input" value="<?php echo $storyview_block_item_block_background_color; ?>" />
                    </div>
                </div>
            </div>
        </div>
